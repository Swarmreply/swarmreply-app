  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8f7f4', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'DM Sans, sans-serif' }}>
      <div style={{ textAlign: 'center' }}>
        <div style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.4rem', fontWeight: 900, color: '#0a0a0a', marginBottom: 8 }}>SwarmReply</div>
        <div style={{ fontSize: '.9rem', color: '#7a7670' }}>Taking you to the login page&hellip;</div>
      </div>
    </div>
  );
}
