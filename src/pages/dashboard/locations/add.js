            ...
            <>
              ...
              {!previewLoading && atMax && (
                <Notice title={`You've reached ${preview.maxSelfServe} locations`}
                  body={<>Plans above {preview.maxSelfServe} locations use agency pricing. Email <a href="mailto:hello@swarmreply.com" style={{ color: 'var(--ink, #0a0a0a)' }}>hello@swarmreply.com</a> and we'll set you up.</>} />
              )}

              {!previewLoading && !atMax && noSub && (
                <Notice title="No active subscription yet"
                  body={<>Additional locations bill to your subscription. If you just signed up it may still be activating — try again shortly, or email <a href="mailto:hello@swarmreply.com" style={{ color: 'var(--ink, #0a0a0a)' }}>hello@swarmreply.com</a>.</>} />
              )}
