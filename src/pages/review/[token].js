        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '32px 16px' }}>
          ...
          {phase === 'share' && (
            <div style={card}>
              ...
              {/* Identical review-ask wording for every path (promoter, passive, detractor, custom):
                  no sentiment-based steering on the public-review invite. */}
              <p style={{ fontSize: '.875rem', color: '#4a4a48', textAlign: 'center', lineHeight: 1.7, marginBottom: 28 }}>
                If you have a moment, we'd love for you to share your experience publicly.
              </p>
